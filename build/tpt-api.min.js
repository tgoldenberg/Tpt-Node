        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                this.transfers = [].concat(_toConsumableArray(this.transfers), _toConsumableArray(response.data.items));
...
function Tpt(apiKey, apiSecret, endpoint) {
  ...
  this.orders = {
    ...
    find: function () {
      var _ref30 = _asyncToGenerator(regeneratorRuntime.mark(function _callee28(options) {
        var url, response;
    ...
    cancel: function () {
      var _ref31 = _asyncToGenerator(regeneratorRuntime.mark(function _callee29(options) {
        var url, response;
    ...
    update: function () {
      var _ref32 = _asyncToGenerator(regeneratorRuntime.mark(function _callee30(options) {
        var url, response;
  ...
  this.portfolio = {
    getCash: function () {
      var _ref33 = _asyncToGenerator(regeneratorRuntime.mark(function _callee31(options) {
        var url, response;
    ...
    getEquities: function () {
      var _ref34 = _asyncToGenerator(regeneratorRuntime.mark(function _callee32(options) {
        var url, response;
    ...
    getHistory: function () {
      var _ref36 = _asyncToGenerator(regeneratorRuntime.mark(function _callee33(_ref35) {
        var account_id = _ref35.account_id,
  ...
  this.market = {
    ...
    getEndOfDayHistory: function () {
      ...
      function getEndOfDayHistory(_x34) {
    ...
    getBrokerRatings: function () {
      var _ref55 = _asyncToGenerator(regeneratorRuntime.mark(function _callee43(options) {
        var url, response;
      ...
      function getBrokerRatings(_x39) {
    ...
    getEarningsEvents: function () {
      var _ref56 = _asyncToGenerator(regeneratorRuntime.mark(function _callee44(options) {
        var url, response;
      ...
      function getEarningsEvents(_x40) {
    ...
    getEarningSurprises: function () {
      var _ref57 = _asyncToGenerator(regeneratorRuntime.mark(function _callee45(options) {
        var url, response;
      ...
      function getEarningSurprises(_x41) {
    ...
    getFinancials: function () {
      var _ref58 = _asyncToGenerator(regeneratorRuntime.mark(function _callee46(options) {
        var url, response;
    ...
    getCompanyNews: function () {
      var _ref59 = _asyncToGenerator(regeneratorRuntime.mark(function _callee47(options) {
        var url, response;
    ...
    getCompanyOwnership: function () {
      var _ref60 = _asyncToGenerator(regeneratorRuntime.mark(function _callee48(options) {
        var url, response;
      ...
      function getCompanyOwnership(_x44) {
    ...
    getCompanyProfile: function () {
      var _ref61 = _asyncToGenerator(regeneratorRuntime.mark(function _callee49(options) {
        var url, response;
      ...
      function getCompanyProfile(_x45) {
    ...
    getCompanyRatios: function () {
      var _ref62 = _asyncToGenerator(regeneratorRuntime.mark(function _callee50(options) {
        var url, response;
      ...
      function getCompanyRatios(_x46) {
...
var t = new Tpt(process.env.TPT_API_KEY, process.env.TPT_API_SECRET, process.env.TPT_ENDPOINT);
var account_id = 'b11b3629-aed8-41ca-b916-16bc2a097369';

t.transfers.getAll({ account_id: account_id });
...
//# sourceMappingURL=tpt-api.min.js.map